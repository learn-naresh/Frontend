...
const Contact = () => {
  return (
    <div className="py-12 grid sm:grid-cols-2 items-center gap-16 my-6 mx-auto max-w-4xl bg-white text-[#333] font-[sans-serif]">
      <div>
          ...
          <div className="mt-12">
              ...
              <ul className="mt-3">
                  <li className="flex items-center">
                      ...
                      <Link to="/" className="text-[#007bff] text-sm ml-3">
